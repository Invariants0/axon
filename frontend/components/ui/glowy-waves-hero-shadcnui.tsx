...
const heroStats: { label: string; value: string }[] = [
  { label: "Tasks Solved", value: "10,230+" },
  { label: "Avg Evolution Time", value: "400ms" },
  { label: "New Capabilities", value: "312" },
];
...
export function GlowyWavesHero() {
  ...
  return (
    <section
      className="relative isolate flex w-full items-center justify-center overflow-hidden bg-background pt-24"
      role="region"
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="mb-6 text-4xl font-semibold tracking-tight text-foreground md:text-6xl lg:text-7xl leading-[1.1]"
          >
            An AI That
            <br />
          ...
          >
            AXON doesn&apos;t just execute tasks. It evolves. It detects its own
            limitations, creates new capabilities, and upgrades itself in
            real-time.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="group gap-2 rounded-full px-8 text-base bg-white text-black hover:bg-white/90 font-medium"
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full border-white/10 bg-background/60 px-8 text-base text-white backdrop-blur transition-all hover:bg-white/5 dark:bg-background/40"
          ...
          <motion.div
            ...
            className="grid gap-4 rounded-2xl border border-border/30 bg-background/60 p-6 backdrop-blur-sm dark:border-border/60 dark:bg-background/70 sm:grid-cols-3 mx-auto max-w-4xl"
          >
            {heroStats.map((stat) => (
              <motion.div
                key={stat.label}
                ...
                className="space-y-1"
              >
                <div className="text-xs uppercase tracking-[0.2em] text-foreground/50 dark:text-foreground/60 w-full mb-1">
                  {stat.label}
                </div>
